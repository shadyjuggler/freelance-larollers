...
const customTheme = {
  ...
  "popup": {
    "root": {
      ...
      "inner": "inline-block rounded-lg bg-red p-4 shadow-lg dark:bg-gray-700"
    },
    "header": {
      "base": "",
...
export const CalendarInput = ({ icon, placeholder }) => {
    ...
    //     <div className="helvetia relative max-w-sm">
    //         <div className="w-8 absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
    //             <img src={icon} alt="" />
    //         </div>
    //         <input datepicker="true" id="datepicker-autohide" datepicker-autohide="true" type="text" className="input" placeholder={placeholder} />
    //     </div>
    // return <Datepicker />;
    // )
